...
import com.example.zanakay.databinding.ActivityMainBinding;
import com.google.android.material.bottomnavigation.BottomNavigationView;
import com.google.android.material.navigation.NavigationBarView;

import java.util.ArrayList;

public class CategorieApprentissage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categorie_apprentissage);
        listcats = findViewById(R.id.listCat);
        chipNavigationBar = findViewById(R.id.bottom_nav);
        bottomMenu();

        int[] imageId = {R.drawable.texte,R.drawable.video};
        String[] cat = {"Articles apprentissage","Videos"};
        String[] descri = {"Lisez des articles pertinents illustres.","Video pour mieux comprendre."};
        //mivadika liste WS articles

        ArrayList<CatApprentissage> catApprentissages = new ArrayList<>();

        for(int j = 0; j < imageId.length; j++){
            CatApprentissage catApprentissage = new CatApprentissage(cat[j], descri[j], imageId[j]);
            catApprentissages.add(catApprentissage);
        }

        ListCatAdapter listCatAdapter = new ListCatAdapter(CategorieApprentissage.this,catApprentissages);
        listcats.setAdapter(listCatAdapter);
        ...
        listcats.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(CategorieApprentissage.this,classes[position]);
                /*parametre cat*/
    ...
    private void bottomMenu() {
        ...
        chipNavigationBar.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                Intent intent = new Intent(CategorieApprentissage.this,c);
                startActivity(intent);
                return false;
            }
        });
